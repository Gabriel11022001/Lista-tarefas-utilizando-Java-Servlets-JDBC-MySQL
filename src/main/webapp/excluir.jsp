...
<head>
	...
	<title>Lista de tarefas - Exclusão</title>
</head>
<body>
	...
	<main class="mt-5 mb-5">
		<section class="container">
			...
			<h3>Certeza que você deseja excluir a tarefa <span style="color: blue;">"<%= tarefa.getTitulo() %>"</span>?</h3>
			<a href="/lista-tarefas/excluir/confirmar?id=<%= tarefa.getId() %>" class="btn btn-danger mt-2">Sim, excluir</a>
			<a href="/lista-tarefas/tarefas" class="btn btn-success mt-2">Cancelar</a>
		</section>
	</main>
